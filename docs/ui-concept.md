...
- Commercial: seller, reliability, stock, **condition** (new vs used/refurbished — non-new listings are filtered out of the comparison; unknown is labelled), delivery, warranty, returns
